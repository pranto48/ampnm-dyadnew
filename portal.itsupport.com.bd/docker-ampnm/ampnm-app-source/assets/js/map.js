function initMap() {
    ...
    function applyRoleBasedVisibility() {
        ...
        // Map controls
        if (els.newMapBtn) els.newMapBtn.style.display = canManage ? '' : 'none';
        if (els.renameMapBtn) els.renameMapBtn.style.display = canManage ? '' : 'none';
        if (els.deleteMapBtn) els.deleteMapBtn.style.display = canManage ? '' : 'none';
        if (els.createFirstMapBtn) els.createFirstMapBtn.style.display = canManage ? '' : 'none';
        if (els.scanNetworkBtn) els.scanNetworkBtn.style.display = canManage ? '' : 'none';
        if (els.placeDeviceBtn) els.placeDeviceBtn.style.display = canManage ? '' : 'none';
        if (els.addDeviceBtn) els.addDeviceBtn.style.display = canManage ? '' : 'none';
        if (els.addEdgeBtn) els.addEdgeBtn.style.display = canManage ? '' : 'none';
        if (els.exportBtn) els.exportBtn.style.display = canManage ? '' : 'none';
        if (els.importBtn) els.importBtn.style.display = canManage ? '' : 'none';
        if (els.mapSettingsBtn) els.mapSettingsBtn.style.display = canManage ? '' : 'none';

        // Context menu items will be handled dynamically in the context menu listener
    }
    ...
    if (els.scanForm) { // Check if element exists before adding listener
    ...
    if (els.scanResults) { // Check if element exists before adding listener
    ...
    if (els.exportBtn) { // Check if element exists before adding listener
    ...
    if (els.importBtn) { // Check if element exists before adding listener
    ...
    if (els.renameMapBtn) { // Check if element exists before adding listener
    ...
    if (els.deleteMapBtn) { // Check if element exists before adding listener
    ...
    if (els.addDeviceBtn) els.addDeviceBtn.addEventListener('click', () => MapApp.ui.openDeviceModal());
    els.cancelBtn.addEventListener('click', () => closeModal('deviceModal'));
    if (els.addEdgeBtn) { // Check if element exists before adding listener
    ...
    if (els.placeDeviceBtn) { // Check if element exists before adding listener
    ...
    if (els.closePlaceDeviceModal) els.closePlaceDeviceModal.addEventListener('click', () => closeModal('placeDeviceModal'));
    if (els.placeDeviceList) { // Check if element exists before adding listener
    ...
    if (els.mapSettingsBtn) { // Check if element exists before adding listener
    ...
    if (els.mapSettingsForm) { // Check if element exists before adding listener
    ...
    if (els.resetMapBgBtn) { // Check if element exists before adding listener
    ...
    if (els.mapBgUpload) { // Check if element exists before adding listener
